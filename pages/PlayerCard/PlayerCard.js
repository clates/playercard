...
export default function PlayerCard({
    ...
    const FALLBACK_URL = "https://ak-static.cms.nba.com/wp-content/uploads/headshots/nba/latest/260x190/201571.png"
    return(
            ...
            <div className="relative">
                <div className="divide-y-4">
                    <div className="relative grid grid-cols-2 mt-3"> 
                        {
                            isError ?
                            <img style={{filter: "blur(10px) grayscale(1)"}} src={FALLBACK_URL}/>
                            :
